...
小麦 OBT 预测模型 — 气态 HTO 经叶片输入后各器官有机结合氚（OBT）的积累预测

## 概述

基于 SOLVEG 框架（Ota et al.）扩展的氚迁移模型，预测大气 HTO 短期/长期暴露后小麦叶片、茎、穗、籽粒中 OBT 的积累。
...
- **光合 OBT 形成**：K_photo × (TFWT/ρ_w) × m_w × f_An × A_n
